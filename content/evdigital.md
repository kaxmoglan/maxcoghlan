...
clients: [AIB, Scottish Widows, WTW]
---
...
technical plans and the estimates used to quote clients, dealing with those
clients directly, mentoring graduate developers and running internal
...
> Led the engineering behind EVDigital, an award-winning suite of fintech
> advice apps, from build through to launch.

## Also on file (not currently used)

One Financial Advisor (onefinancialadviser.com) — a first-of-its-kind D2C
retirement-advice app. Small in-house team plus external contractors; built a
Storybook component library, complex internal/external API integrations, PDF
generation, and a context-aware 3D browser-rendered avatar chatbot. Ended up
the senior and only developer seeing it through. Same domain as EVDigital
(retirement / financial advice) — could be folded into the EVDigital story or
kept as a second data point if a design wants two.
