      ...
      <div className="various custom-content">
        <div className="project-body">
          <div className="narrow">
            <h2>A To Do List</h2>
            <p>
              A to-do list I created using React & Sass. Users can create, edit
              and delete to-do items and mark them as completed or incomplete.
              ‘All’, ‘Active’ and ‘Completed’ lists are generated based on each
              to-do’s current state and the lists are stored in the browser’s
              local storage so users can pick up where they left off.
            </p>
            <p>
              Items can also be reordered with intuitive drag and drop
              functionality that also works with touch, and users can change the
              app’s colour theme with the palette picker in the bottom left
              corner.
            </p>
            <div className="links">
              <a
              ...
              <div className="mobile-only__container">
                ...
                <div className="mobile-only__text">
                  ...
                  <p>
                    ...
                    as the input device. Your equation is shown in the top part
                    of the screen and the result and current input is shown on
                    the lower, larger screen.
                  </p>
                  <p>
                    This was a big lesson in just how much logic there is with
                    something as seemingly trivial as a calculator, but a lot of
                    fun to sit and work out. I’d like to implement ‘backspace’
                    functionality, but apart from that, it works like a
                    calculator!
                  </p>
                  <div className="links">
                    <a
          ...
          <div className="narrow">
            <div className="drum-machine">
              ...
              <div className="drum-machine__text">
                ...
                <p>
                  A drum machine I created using React & Sass. There are 2 kits
                  (or sound banks) which are switchable via the plus and minus
      ...
      <div className="more-projects">
        <div className="more-projects__container">
          ...
          <div className="more-projects__next">
            ...
            <Link className="project__link" to={`/projects/${PROJECTS[0].url}`}>
